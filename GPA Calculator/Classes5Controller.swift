...
class Classes5Controller: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let tap: UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(Classes5Controller.dismissKeyboard))
    ...
    {
        if Credits1TF.text == "" || Credits2TF.text == "" || Credits3TF.text == "" || Credits4TF.text == "" || Credits5TF.text == "" || Grade1TF.text == "" || Grade2TF.text == "" || Grade3TF.text == "" || Grade4TF.text == "" || Grade5TF.text == ""
        {
            let title = "Oops"
        ...
        else
        {
            ...
            if CumCredits.text == "" || CumGPA.text == ""
            {
                ...
                let allcredits = credit1 + credit2 + credit3 + credit4 + credit5
                let allgrades = firstgrade + secondgrade + thirdgrade + fourthgrade + fifthgrade
